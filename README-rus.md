...
**Перед устноавки или сборки обязательно ознакомьтесь c [Лицензией](https://github.com/anonyaro/TableTime/blob/master/LICENSE)**  
...
| **Рендеринг** | **Custom Drawing** — полностью кастомная отрисовка всех графических элементов управления |
