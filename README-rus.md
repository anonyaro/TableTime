...
| Технология / Фича | Описание |
| :--- | :--- |
| **Язык программирования** | **C++** (Native) — максимальная производительность и контроль памяти |
| **Интерфейс (API)** | **WINAPI** — прямое взаимодействие с ОС Windows без лишних надстроек |
| **Рендеринг** | **Custom HDC Drawing** — полностью кастомная отрисовка всех графических элементов управления |
