...
# **Перед установкой или сборкой TableTime (Cards_by_xeNYARO) обязательно ознакомьтесь c: [Лицензией](https://github.com/anonyaro/TableTime/blob/master/LICENSE)**
...
# Мануал к сборке
*Если вы решились собирать проект с нуля убедитесь в соответсвии путей к библиотеками и ресурсам, либо перместите все в один единый каталог, также можно поменять пути в самих исходниках вручную*

# **Технический стек и особенности**
| Технология | Описание |
| :--- | :--- |
| **Язык программирования** | **C++17/20** (Native) — максимальная производительность и контроль памяти |
| **Интерфейс (API)** | **WINAPI** — прямое взаимодействие с ОС Windows без лишних надстроек |
| **Рендеринг GDI/GDI+** | **Custom HDC Drawing** — полностью кастомная отрисовка всех графических элементов управления |
| **Конфиденциальность** | **Anti-Screen Capture** — программная защита от захвата окна в OBS, Discord, Zoom и др. |
